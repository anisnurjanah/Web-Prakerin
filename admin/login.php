...
if(isset($_POST['login'])){
    ...
    $cek = mysqli_query($conn, "select * from masuk where username='$username' and password='$password'");
...
<body>
    ...
    margin-right: auto;">
            <div class="card-body">
                ...
                <br>
                    <span><a href="loginsiswa.php" style="font-weight: bold;"> LOGIN SEBAGAI SISWA </a></span>
                </form>
            </div>
        </div></center>
    </div>
